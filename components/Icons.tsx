...
export const UploadIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3 17.25V21h18v-3.75M4.5 12.75l-1.5-1.5L9 3l4.5 8.25-1.5 1.5M21 12.75l-1.5-1.5L15 3l-4.5 8.25 1.5 1.5" />
  </svg>
);
...
export const ShareIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.042.583.05a2.25 2.25 0 011.993 1.993c.009.193.026.387.05.583m0 0a2.25 2.25 0 002.186 0m0 0c.025-.195.042-.39.05-.583a2.25 2.25 0 011.993-1.993c.193-.009.387-.026.583-.05m0 0a2.25 2.25 0 000-2.186m0 2.186c-.195.025-.39.042-.583.05a2.25 2.25 0 01-1.993-1.993c-.009-.193-.026-.387-.05-.583m0 0a2.25 2.25 0 00-2.186 0" />
    </svg>
);
